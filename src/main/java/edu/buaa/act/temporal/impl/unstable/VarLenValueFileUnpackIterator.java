 ...
 */
public class VarLenValueFileUnpackIterator implements PeekingIterator<ETVEntry>, SearchableIterator<ETEntry>
{
    ...
    public VarLenValueFileUnpackIterator(ByteBuffer fileBuffer, int dataLen, int indexLen)
    {
        this.in = fileBuffer;
        this.in.flip();
        this.indexStart = dataLen;
