...
public class BlockLatestValueIterator implements SeekingIterator<Slice, Slice>
{
    ...
    public BlockLatestValueIterator(Slice data, Slice restartPositions, Comparator<Slice> comparator)
    {
